      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <StatCard
              title="Royalty in 2026"
              value={dashboardData.royaltyIn2026}
              bgColor="bg-gradient-to-br from-purple-600 to-purple-500"
            />
            <StatCard
              title="Royalty in Feb, 2026"
              value={dashboardData.royaltyInFeb2026}
              bgColor="bg-gradient-to-br from-red-700 to-red-600"
            />
            <StatCard
              title="Royalty this week"
              value={dashboardData.royaltyThisWeek}
              bgColor="bg-gradient-to-br from-blue-800 to-blue-700"
            />
            <StatCard
              title="Royalty Transferred"
              value={dashboardData.royaltyTransferred}
              bgColor="bg-gradient-to-br from-green-600 to-green-500"
            />
            <StatCard
              title="Book sold in 2026"
              value={dashboardData.booksSoldIn2026}
              bgColor="bg-gradient-to-br from-teal-600 to-teal-500"
              isRupee={false}
            />
            <StatCard
              title="Book sold in Feb, 2026"
              value={dashboardData.booksSoldInFeb2026}
              bgColor="bg-gradient-to-br from-yellow-700 to-yellow-600"
              isRupee={false}
            />
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                onClick={() => router.push("/author/dashboard/royalties")}
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-gray-800">
                Recent 5 Royalty Withdrawals
              </h2>
              <button className="bg-blue-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-blue-700 transition-colors" onClick={() => router.push("/author/dashboard/transfers")}>
                View All
              </button>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b-2 border-gray-200">
                    {["#", "Amount", "Date", "Status", "Transaction ID"].map(
                      (h) => (
                        <th
                          key={h}
                          className="text-left py-4 px-4 font-semibold text-gray-700"
